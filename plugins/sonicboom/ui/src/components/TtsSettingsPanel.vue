...
/**
 * SonicBoom TTS settings panel. Runs inside the isolated plugin UI (never
 * the main TikTools document) and talks to the host only through the
 * restricted broker (`settings.*`, `actions.*`, `options.*`).
 */
