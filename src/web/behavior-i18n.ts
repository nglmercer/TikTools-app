...
export const BEHAVIOR_UI_TRANSLATIONS: TranslationCatalog = {
  en: {
    ...ns("behavior.copy.", {
      ...
      newEvent: "New event",
      moderationPenalty: "Moderation penalty",
      moderationPenaltyHint: "Deduct points whenever TextIntel blocks a chat message.",
      moderationPenaltyLead: "One amount creates the points action and its event in a single step.",
      moderationPenaltyPoints: "Points",
      moderationPenaltyPointsHint: "Negative deducts, positive awards. Viewers never drop below zero.",
      moderationPenaltyViewer: "Viewer",
      moderationPenaltyNotFinite: "Enter a finite number.",
      moderationPenaltyZero: "The penalty must be non-zero.",
      moderationPenaltySaveHint: "Create the points action and the blocked-message event.",
  ...
  es: {
    ...ns("behavior.copy.", {
      ...
      moderationPenalty: "Penalización de moderación",
      moderationPenaltyHint: "Resta puntos cuando TextIntel bloquee un mensaje del chat.",
      moderationPenaltyLead: "Una cantidad crea la acción de puntos y su evento en un solo paso.",
      moderationPenaltyPoints: "Puntos",
      moderationPenaltyPointsHint: "Negativo resta, positivo suma. Los espectadores nunca bajan de cero.",
      moderationPenaltyViewer: "Espectador",
      moderationPenaltyNotFinite: "Introduce un número finito.",
      moderationPenaltyZero: "La penalización no puede ser cero.",
      moderationPenaltySaveHint: "Crea la acción de puntos y el evento de mensaje bloqueado.",
