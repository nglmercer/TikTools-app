...
import { defaultWidgetLayers, removeDefaultHeadingLayers, updateWidgetLayer } from '../../widgets/sdk/layers.ts';
...
export default defineVueComponent<Props>(['locale', 'kind', 'title', 'design', 'onSave', 'onClose'], (props) => {
  ...
  const draft = ref<WidgetStyle>(removeDefaultHeadingLayers(props.kind, cloneDesign(props.design)));
